...
export class UpdateChecker {
    ...
    async init() {
        try {
            ...
            const response = await fetch('update_api.php?action=get_version');
    ...
    async checkForUpdates() {
        ...
        try {
            const response = await fetch('update_api.php?action=check_version');
            const data = await response.json();
    ...
    async startUpdate() {
        ...
        try {
            const response = await fetch('update_api.php?action=start_update', {
                method: 'POST'
            });
    ...
    async rollback() {
        try {
            const response = await fetch('update_api.php?action=rollback', {
                method: 'POST'
            });
